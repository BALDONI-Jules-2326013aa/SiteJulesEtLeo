document.addEventListener("DOMContentLoaded", function() {
  ...
  function changeMode() {
    ...
    for (let i = 0; i < document.body.children.length; i++) { //Ici c'est une petite boucle for pour bien modifier toute la page
      document.body.children[i].classList.toggle('light', soleil);
    }
